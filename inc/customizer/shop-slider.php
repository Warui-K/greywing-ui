<?php function gr_shop_slider_customize_section($wp_customize)
{
    ...
    $wp_customize->add_setting(
        'gr_shop_slider_price_1',
        ['default' => '2000']
    );
    $wp_customize->add_setting(
        'gr_shop_slider_link_1',
        ['default' => '']
    );
    ...
    $wp_customize->add_setting(
        'gr_shop_slider_price_2',
        ['default' => '2000']
    );
    $wp_customize->add_setting(
        'gr_shop_slider_link_2',
        ['default' => '']
    );
    ...
    $wp_customize->add_setting(
        'gr_shop_slider_price_3',
        ['default' => '2000']
    );
    $wp_customize->add_setting(
        'gr_shop_slider_link_3',
        ['default' => '']
    );
    ...
    $wp_customize->add_setting(
        'gr_shop_slider_price_4',
        ['default' => '2000']
    );
    $wp_customize->add_setting(
        'gr_shop_slider_link_4',
        ['default' => '']
    );
