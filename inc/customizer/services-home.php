    <?php function gr_services_home_customize_section($wp_customize)
{
    ...
    $wp_customize->add_control(
        new WP_Customize_Control(
            ...
            'type' => 'text',
            'input_attrs' => array(
                'placeholder' => __('bi bi-hexagon-half', 'greywingwp'),
            )
    ...
    $wp_customize->add_control(
        new WP_Customize_Control(
            ...
            'type' => 'text',
            'input_attrs' => array(
                'placeholder' => __('bi bi-exclude', 'greywingwp'),
            )
    ...
    $wp_customize->add_control(
        new WP_Customize_Control(
            ...
            'type' => 'text',
            'input_attrs' => array(
                'placeholder' => __('bi bi-diamond-half', 'greywingwp'),
            )
    ...
    $wp_customize->add_control(
        new WP_Customize_Control(
            ...
            'type' => 'text',
            'input_attrs' => array(
                'placeholder' => __('bi bi-shield-fill-plus', 'greywingwp'),
            )
