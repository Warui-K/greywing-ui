...
//setting
    ...
    $wp_customize->add_setting('gr_slider_1',
    ['default' => '']);
    $wp_customize->add_setting('gr_slider_h_1',
    ['default' => 'Healthcare Consultancy']);
    $wp_customize->add_setting('gr_slider_t_1',
    ...
    $wp_customize->add_setting('gr_slider_l_1',
    ['default' => '']);

    $wp_customize->add_setting('gr_slider_2',
    ['default' => '']
    );
    $wp_customize->add_setting('gr_slider_h_2',
    ['default' => 'Hospital Development Services']
    );
    $wp_customize->add_setting('gr_slider_t_2',
    ['default' => 'One of our key areas of focus is facility planning, design, construction and development']);
    $wp_customize->add_setting('gr_slider_l_2',
    ['default' => '']);

    $wp_customize->add_setting('gr_slider_3',
    ['default' => '']
    );
    $wp_customize->add_setting('gr_slider_h_3',
    ['default' => 'Public Healthcare Consulting']
    );
    $wp_customize->add_setting('gr_slider_t_3',
    ...
    ']);
    $wp_customize->add_setting('gr_slider_l_3',
    ['default' => '']);

    $wp_customize->add_setting('gr_slider_4',
    ['default' => '']
    );
    $wp_customize->add_setting('gr_slider_h_4',
    ['default' => 'Medical Equipment Supplies']
    );
    $wp_customize->add_setting('gr_slider_t_4',
    ['default' => 'Shop for high quality products at the most affordable and sustainable prices
    ']);
    $wp_customize->add_setting('gr_slider_l_4',
    ['default' => '']);
    

    //Section
$wp_customize->add_section('gr_slider', 
[
